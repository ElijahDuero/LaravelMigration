...
const today1yr = new Date();
today1yr.setFullYear(today1yr.getFullYear() + 1);

export default function SoftwareCreate({ nextSwId, branches }: Props) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        expiry_date:    today1yr.toISOString().split('T')[0],
        cost_annual:    '',
        supplier:       '',
        po_number:      '',
        invoice:        '',
    ...
    const selMeta = data.category ? (CAT_META[data.category] ?? null) : null;

    return (
        <AppLayout title="Register Software" subtitle="Add a new software license to inventory">
            <form onSubmit={submit} className="space-y-6">

                {/* Header */}
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div className="flex items-center space-x-3">
                        <Link href="/software" className="p-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition">
                            <i className="fas fa-arrow-left text-gray-600"></i>
                        </Link>
                        <div>
                            <h2 className="text-xl font-semibold text-gray-900">Register Software License</h2>
                            <p className="text-sm text-gray-500">Enter software and license information below</p>
                        </div>
                    </div>
                    <div className="flex flex-wrap items-center gap-2">
                        <Link href="/software" className="btn btn-secondary"><i className="fas fa-times mr-2"></i>Cancel</Link>
                        <button type="submit" disabled={processing} className="btn btn-primary">
                            <i className="fas fa-floppy-disk mr-2"></i>Save Software
                        </button>
                    </div>
                </div>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="card p-6">
                            <div className="flex items-center space-x-3 mb-6">
                                <div className={`w-10 h-10 ${selMeta ? `bg-${selMeta.color}-100` : 'bg-blue-100'} rounded-lg flex items-center justify-center`}>
                                    <i className={`fas ${selMeta ? selMeta.icon : 'fa-box'} ${selMeta ? `text-${selMeta.color}-600` : 'text-blue-600'}`}></i>
                                </div>
                                <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div className="md:col-span-2">
                                    ...
                                    <input type="text" className="form-input bg-gray-50 font-mono" value={nextSwId} readOnly />
                                ...
                                <div>
                                    ...
                                    <input type="text" className="form-input" placeholder="e.g., 2406 (Build 17726)"
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <textarea rows={4} className="form-input"
                                        placeholder="Describe what this software is used for, any special configurations, etc."
                        ...
                        <div className="card p-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <input type="text" className="form-input font-mono text-sm" placeholder="XXXXX-XXXXX-XXXXX-XXXXX"
                                ...
                                <div>
                                    ...
                                    <input type="number" className="form-input" min="0" placeholder="e.g., 500"
                        ...
                        <div className="card p-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-400 mt-1">Leave blank for perpetual licenses</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="text" className="form-input" placeholder="e.g., Microsoft CSP Partner Inc."
                                ...
                                <div>
                                    ...
                                    <input type="text" className="form-input" placeholder="e.g., PO-2026-0789"
                                ...
                                <div>
                                    ...
                                    <input type="text" className="form-input" placeholder="e.g., INV-2026-XXXX"
                    ...
                    <div className="space-y-6">
                        <div className="card p-6 border-l-4 border-amber-500 bg-gradient-to-br from-amber-50/50 to-white">
                            ...
                            <ul className="space-y-1.5 text-xs text-gray-600">
                                <li className="flex items-start"><i className="fas fa-check text-green-500 mt-0.5 mr-2 text-[10px]"></i>Keep license keys and proofs of purchase for software audits</li>
                                <li className="flex items-start"><i className="fas fa-check text-green-500 mt-0.5 mr-2 text-[10px]"></i>Track installations to prevent exceeding license counts</li>
                                <li className="flex items-start"><i className="fas fa-check text-green-500 mt-0.5 mr-2 text-[10px]"></i>Set renewal reminders 60 days before expiration</li>
                                <li className="flex items-start"><i className="fas fa-check text-green-500 mt-0.5 mr-2 text-[10px]"></i>Periodically uninstall from devices no longer in use</li>
                            </ul>
                        </div>
